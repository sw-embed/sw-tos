...
for expected in 'Hello' 'B1' 'B2' 'Uptime' '00:05' '00:06' '00:07' 'Clock' '12:34:56' '12:34:57' '12:34:58' 'BAD'; do
...
if [ "$menu_count" -ne 6 ]; then
    echo "FAIL: expected six scheduled menu displays, saw $menu_count" >&2
    echo "$output" >&2
    exit 1
fi
