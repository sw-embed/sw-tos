...
def render_scheduled(entries: list[dict], manifest: Path) -> str:
    ...
    shell_strings = {
        ...
        "SHELL_TOPIC_MEM": "mem totals, mem -r resets, mem -p per process with addresses",
        ...
        "SHELL_BAD_TEXT": "BAD",
        "SHELL_MENU_TEXT": "MENU 1=Hello 2=Counter 3=Uptime 4=Clock 5=Multitask 9=Fill",
        "SHELL_ERROR_TEXT": "ERROR",
        "SHELL_READY_TEXT": "READY",
        "SHELL_HELLO_TEXT": "Hello",
